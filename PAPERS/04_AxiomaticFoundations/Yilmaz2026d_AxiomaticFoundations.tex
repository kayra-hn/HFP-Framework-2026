...
\[
\rho_{\text{obs}} = \operatorname{Tr}_{w} |\Psi\rangle\langle\Psi|,
\]
...
\bibitem{Yilmaz2026d}
Yılmaz, K. (2026). 
\textit{Hyper-Flux Projection Model: Numerical Implementation and Cosmological Implications (Unpublished Manuscript)}. 
